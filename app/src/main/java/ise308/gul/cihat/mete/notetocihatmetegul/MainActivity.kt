...
import android.content.Intent as Inte
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        jsonsSerializer = JSONSerializer("NoteToSelf", applicationContext)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        val b = when (id) {
            R.id.settings -> {
                val intentToSetting = Inte(this, SettingsActivity::class.java)
